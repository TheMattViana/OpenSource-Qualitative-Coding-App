...
export const MemoSidebar: React.FC<Props> = ({ project, activeTranscript, onUpdateProject, onClose }) => {
    ...
    <div className="w-80 bg-[var(--bg-panel)] border-l border-[var(--border)] flex flex-col h-full shadow-xl z-20 shrink-0">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6 bg-[var(--bg-main)]">
        ...
        <div className="space-y-2">
           ...
           {activeTranscript ? (
             <textarea 
               className="w-full h-48 p-3 text-sm border border-[var(--border)] rounded-lg focus:ring-2 focus:ring-[var(--accent)] focus:border-[var(--accent)] bg-[var(--bg-panel)] text-[var(--text-main)]"
        ...
        <div className="space-y-2 h-1/2">
           ...
           <textarea 
               className="w-full h-64 p-3 text-sm border border-[var(--border)] rounded-lg focus:ring-2 focus:ring-[var(--accent)] focus:border-[var(--accent)] bg-[var(--bg-panel)] text-[var(--text-main)]"
